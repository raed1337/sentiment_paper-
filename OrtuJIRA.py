...
for j in range(4):
    ...
    for i in range(kf):
        test_df  = df[df.index == "OrtuJIRA_test_{}".format(i)]
        train_df = df[df.index != "OrtuJIRA_test_{}".format(i)]
        ...
        print("Accuracy of {} on OrtuJIRA is: {}".format(m_name, accuracy_score(flat_true_labels,flat_predictions)))
...
df_final.to_excel('OrtuJIRA.xlsx',index=False)
